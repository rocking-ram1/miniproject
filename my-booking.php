...
<title>Car Castle Rental Services - My Booking</title>
<!--Bootstrap -->
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Confirmed</a>
                           <div class="clearfix">
 <a href="payment.php">
<button type="submit" name="Make Payment" class="btn btn-block">Make Payment <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span>
</button>
</a>  
</div>
        </div>
